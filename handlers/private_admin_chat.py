...
class AddProduct(StatesGroup):
    ...
    texts = {
        ...
        'AddProduct:description': 'Введите заново название товара:',
        'AddProduct:price': 'Введите заново  описание товара:',
        'AddProduct:image': 'Введите заново цену товара:',
...
@admin_router.message(StateFilter('*'), Command("отмена"))  # State('*') -находимся в каком либо состоянии диалога
